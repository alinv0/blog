---
title: "The 90% Trap: Why AI-Generated Code Feels Done but Isn't"
slug: the-90-percent-trap
excerpt: "AI gets you to 90% remarkably fast. But that last 10% — edge cases, error handling, security, operational behavior — is where engineering actually happens. And skipping it is more dangerous than it used to be."
category: engineering
categoryName: Engineering
author: "Alin Voinea"
authorBio: "Software Engineer"
publishedAt: "2026-03-28T13:00:00.000Z"
coverImage: cover.png
tags: "ai, testing, quality, engineering, decision-making, speed"
linkedinPost: |
  **AI makes code *look* finished long before it’s actually safe to ship.**
  
  The dopamine hit of “done” now arrives at ~90%.
  
  Copilot (or any LLM) helps you breeze through the obvious parts.  
  Tests pass. UI works. Green checks everywhere.
  
  But the real work? That’s what gets skipped.
  
  Edge cases. Failure modes. Operational reality.  
  None of these are fully represented in the prompt—or the training data.
  
  AI solves the problem you described.  
  Not the one you’ll meet in production at 3am.
  
  And that gap is where bugs—and security issues—hide.
  
  This isn’t theoretical.  
  In practice (and in studies), AI-generated code fails most where correctness actually matters.
  
  The faster we move, the easier it is to miss what *wasn’t* generated.
  
  **The real engineering skill now is different:  
  seeing what’s missing when everything “looks” done.**
  
  Where have you seen the 90% trap in your team—or hit it yourself?
...
This isn't just anecdotal. Research shows LLM-generated code pass rates drop by up to 29% when tested against comprehensive edge cases rather than basic test suites ([Liu et al., NeurIPS 2023](https://arxiv.org/abs/2305.01210)).
...
Research out of NYU Tandon has found that code models generate functions with security vulnerabilities at an alarming rate, unless security is specified explicitly ([Pearce et al., 2022](https://arxiv.org/abs/2108.09293)). In a systematic study, roughly 40% of Copilot-generated programs were found to be vulnerable to attacks mapped to MITRE’s CWE Top 25 ([NYU Tandon CCS Research](https://cyber.nyu.edu/2021/10/15/ccs-researchers-find-github-copilot-generates-vulnerable-code-40-of-the-time/)).
...
Kent Beck’s classic TDD approach surfaces failures early ([Beck, TDD By Example](https://www.amazon.com/Test-Driven-Development-By-Example/dp/0321146530)), but with AI code, the need is even sharper. Research confirms that providing LLMs with tests alongside problem statements consistently improves code generation outcomes ([Mathews et al., TDD for Code Generation](https://arxiv.org/abs/2402.13521)).
